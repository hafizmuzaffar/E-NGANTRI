   ...
   <section class="team-area section-gap">
            <div class="container">
               ...
               <h3 class="pb-20 text-center mb-30" Lihat Tanggal Antrian>
                <form action="<?php echo base_url('welcome/lihat_antrian') ?>" method="POST">
                <label>Pilih Tanggal Antrian</label>
                    <input id="datepicker1" name="tanggal_antrian" class="form-control"  placeholder="Tanggal Pesan" autocomplete="off"> <br><br>
                 <select class="form-control" name="pilih_dokter" required='pilih_dokter'>
                    ...
                    <center><a class="btn btn-success" href="<?php echo base_url('pasien/index'); ?>">kembali</a>
                <input type="submit" name="submit" value="lihat antrian" class="btn btn-primary"></center>
                </form>
