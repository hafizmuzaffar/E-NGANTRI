...
<body>
  <div class="col-lg-6 col-md-6 appointment-right pt-60 pb-60">
              <form class="form-wrap" action="<?php echo base_url('welcome/daftar_pasien_simpan'); ?>" method="POST">
                <h3 class="pb-20 text-center mb-30">Tambah Pasien</h3>    
                ...
                <input type="number" class="form-control" name="nik" placeholder="Nik" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nik'" > <br>
