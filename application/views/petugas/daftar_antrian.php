        ...
        <div class="page-header page-header-default">
          <div class="page-header-content">
            <div class="page-title">
              <h4><i class="icon-arrow-left52 position-left"></i> Data Antrian</h4>
            </div>
          ...
          <div class="breadcrumb-line">
            ...
            <ul class="breadcrumb-elements">
              <li><a href="#"><i class="icon-calendar2 position-left"></i> <span id="clock"></span></a></li>
                  ...
                  <center><h3>Tabel Dokter Umum</h3></center>
                  <table border="5" class="table">
                    ...
                    <center><h3>Tabel Dokter Gigi<h3></center>
                    <table border="5" class="table">
                        <thead>
                            <tr>
                                <th>No</th>
                    ...
                    <center><h3>Tabel Dokter Anak</h3></center>
                    <table border="5" class="table">
                        <thead>
                            <tr>
                                <th>No</th>
                    ...
                    <center><h3>Tabel Bidan</h3></center>
                    <table border="5" class="table">
                        <thead>
                            <tr>
                                <th>No</th>
            ...
            <a href="<?php echo base_url('petugas/pilih_cetak_poli'); ?>" class="btn btn-primary">Cetak Laporan Data Antrian</a>
            <br> <br>  
             <div class="col-lg-4">
