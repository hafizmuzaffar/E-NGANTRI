...
<head>
  ...
  <script type="text/javascript" src="<?php echo base_url(); ?>assets4/backend/js/core/libraries/jquery.min.js">
  </script>
  <script type="text/javascript" src="<?php echo base_url(); ?>assets4/backend/js/core/libraries/bootstrap.min.js">
  </script>
  <script type="text/javascript" src="<?php echo base_url(); ?>assets4/backend/js/plugins/loaders/blockui.min.js">
  </script>
  ...
  <!-- Theme JS files -->
  <script type="text/javascript" src="<?php echo base_url(); ?>assets4/backend/js/plugins/visualization/d3/d3.min.js">
  </script>
  ...
  <script type="text/javascript" src="<?php echo base_url(); ?>assets4/backend/js/plugins/forms/styling/uniform.min.js">
  </script>
  ...
  <script type="text/javascript" src="<?php echo base_url(); ?>assets4/backend/js/plugins/ui/moment/moment.min.js">
  </script>
  <script type="text/javascript" src="<?php echo base_url(); ?>assets4/backend/js/plugins/pickers/daterangepicker.js">
  </script>

  <script type="text/javascript" src="<?php echo base_url(); ?>assets4/backend/js/plugins/ui/nicescroll.min.js">
  </script>
  ...
  <script type="text/javascript" src="<?php echo base_url(); ?>assets4/backend/js/pages/dashboard_boxed_full.js">
  </script>
    ...
    <div class="navbar-collapse collapse" id="navbar-mobile">
      <ul class="nav navbar-nav">
        ...
        <li class="<?php if ($title == 'Data Spesialis') {
                    ...
                    ?>">
          <a href="<?php echo base_url(); ?>index.php/petugas/daftar_antrian">
  ...
  <div class="page-container">
    ...
    <div class="page-content">
      ...
      <div class="content-wrapper">
        ...
        <a href="<?php echo base_url(); ?>index.php/petugas/tambah_pasien" class="btn btn-primary btn-sm"><i class="icon-add"></i> Tambah Data Pasien</a> <br /><br />
        ...
        <table width="100%" border="1" class="table" bordercolor="#66CCCC" cellspacing="0" cellpadding="0">
          <tr class="bg-blue">
            ...
            <td align="center">Nomor Telp</td>
            <td align="center">Tanggal Lahir</td>
            <td align="center">Email</td>
            <!-- <td align="center">Jenis Pasien</td>
            <td align="center">Nomor Asuransi</td> -->
            <td align="center">Edit</td>
            <td align="center">Delete</td>
            <td align="center">Tambah_antrian</td>
          </tr>
          <?php $no = 1; ?>
          <?php foreach ($pasien as $p) { ?>
            <tr>
              ...
              <td align="center"><?php echo $p->alamat; ?> </td>

              <td align="center"><?php echo $p->nomor_tlp; ?></td>
              <td align="center"><?php echo $p->tgl_lahir; ?></td>
              <td><?php echo $p->email; ?> </td>
              <!-- <td align="center"><?php echo $p->pilih_metode_pembayaran; ?></td>
              <td align="center"><?php echo $p->no_asuransi; ?></td> -->
              <td align="center"><a href="<?=
                                          base_url('petugas/edit_pasien/' . $p->id_user); ?>"><i class="icon-menu"></i></a></td>
              <td align="center"><a href="<?= base_url('petugas/p_hapus_pasien/' . $p->id_user); ?>" onclick="return konfirmasi();"><i class="icon-trash"></i></td></a>
              <td align="center"><a href="<?= base_url('petugas/tambah_antrian/' . $p->id_user); ?>" <i class="icon-people"></a></i></td>
